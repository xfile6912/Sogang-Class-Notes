...
PCADoc.h, PCADoc.cpp - the document
    These files contain your CPCADoc class.  Edit these files to
    add your special document data and to implement file saving and loading
    (via CPCADoc::Serialize).

PCAView.h, PCAView.cpp - the view of the document
    These files contain your CPCAView class.
    CPCAView objects are used to view CPCADoc objects.
