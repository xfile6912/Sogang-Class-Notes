...
#define FEATURE_OXFD_COLOR cvScalar(255,255,0)
#define FEATURE_LOWE_COLOR cvScalar(255,0,255)
...
struct feature
{
	...
	double dist0;	// added distance to the closest match, unsang
	bool trimmed;	// added to mark trimmed features, unsang
	double fx;	// forward x
	double fy;	// forward y
	bool matched;
